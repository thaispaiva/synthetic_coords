...
load("/net/nfs1/s/grad/tvp/Project - Jerry/Death data/y tilda/size20/utility/utility_size20_orig_nonadapt_newprior.RData")
glm.orig = glm.sp

glm.synt2 = list(1); glm.synt2 = c(glm.synt2,2:10)
load("/net/nfs1/s/grad/tvp/Project - Jerry/Death data/y tilda/size20/utility/utility_size20_syntp1_nonadapt_newprior.RData")
glm.synt2[[1]] = glm.synt[[1]]; glm.synt2[[2]] = glm.synt[[2]];
load("/net/nfs1/s/grad/tvp/Project - Jerry/Death data/y tilda/size20/utility/utility_size20_syntp2_nonadapt_newprior.RData")
glm.synt2[[3]] = glm.synt[[3]]; glm.synt2[[4]] = glm.synt[[4]]
load("/net/nfs1/s/grad/tvp/Project - Jerry/Death data/y tilda/size20/utility/utility_size20_syntp3_nonadapt_newprior.RData")
glm.synt2[[5]] = glm.synt[[5]]; glm.synt2[[6]] = glm.synt[[6]]
load("/net/nfs1/s/grad/tvp/Project - Jerry/Death data/y tilda/size20/utility/utility_size20_syntp4_nonadapt_newprior.RData")
glm.synt2[[7]] = glm.synt[[7]]; glm.synt2[[8]] = glm.synt[[8]]
load("/net/nfs1/s/grad/tvp/Project - Jerry/Death data/y tilda/size20/utility/utility_size20_syntp5_nonadapt_newprior.RData")
...
pdf("spreg_plot_newprior.pdf", width=12, height=12, pointsize=20)
